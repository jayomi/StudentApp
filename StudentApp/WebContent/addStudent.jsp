...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			<form action="StudentData" class="form-horizontal">
				<div class="form-group">
					<label class="col-sm-2 control-label">Id</label>
					<div class="col-sm-10"><input class="form-control" type="text" name="stId"/></div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-2 control-label">Name</label>
					<div class="col-sm-10"><input class="form-control" type="text" name="stName"/></div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-2 control-label">Age</label>
					<div class="col-sm-10"><input class="form-control" type="text" name="stAge"/></div>
				</div>			
					
							
				<input class="btn btn-lg btn-primary btn-block" type="submit" value="save" name="addSt"/><br/><br/>
			</form>
		</div>
